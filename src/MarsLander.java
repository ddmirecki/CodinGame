...
public class MarsLander {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            System.out.println("0 " + moc(vSpeed)); // 2 integers: rotate power. rotate is the desired rotation angle (should be 0 for level 1), power is the desired thrust power (0 to 4).
        }
    }


    public static int moc(int h){
        if(h < -20){
            return 4;
        }else if(h > -20){
            return 3;
